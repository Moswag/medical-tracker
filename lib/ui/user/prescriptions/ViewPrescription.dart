...
class _ViewScheduleState extends State<ViewPrescription> {
...
//  }
  ...
  _asyncMethod() async {
    ...
    user = await UserRepository.getUser(widget.prescription.doctorId);
    nameController.text='Doctor Name: '+user.firstName+' '+user.lastName;
  ...
  Widget build(BuildContext context) {
    ...
    if (!appState.isLoading &&
      ...
      final submitButton = Visibility(
          visible:
          widget.prescription.hasFeedBack==true?false:true,
          child:Expanded(
        child: RaisedButton(
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext ctx) =>
                            AddPrescriptionFeedback(prescription: widget.prescription,)));
              });
            }),
      ));
            ...
            onPressed: () {
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          Chat(
                            peerId: widget.prescription.doctorId,
