...
import 'package:medicaltracker/ui/admin/tips/AddTip.dart';
...
class AdminViewTips extends StatefulWidget {

  @override
  State createState() => _ViewTipsState();
}

class _ViewTipsState extends State<AdminViewTips> {
    ...
    ListView getNoteListView() {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int position) {
          HealthTip healthTip=HealthTip.fromDocument(document[position]);
              ...
              child: Container(
                ...
                child: ListTile(
                  leading: CircleAvatar(
                      backgroundColor: Color.fromRGBO(58, 66, 86, 1.0), child: Icon(Icons.trip_origin)),
                  title: Text('Tip:  ${healthTip.tip}',
                      style: TextStyle(
                  ...
                  trailing: GestureDetector(
                    ...
                    onTap: () {
                      Firestore.instance.collection(TABLE_TIPS).document(healthTip.id).delete();

                      Scaffold.of(context).showSnackBar(
                          new SnackBar(content: new Text('Health Tip Deleted')));
                    },
                  ),
