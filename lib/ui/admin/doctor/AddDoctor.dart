...
class AddDoctor extends StatefulWidget {
  @override
  State createState() => _AddDoctorState();
}
...
class _AddDoctorState extends State<AddDoctor> {
    ...
    if (_formKey.currentState.validate()) {
      try {
        ...
        AlertDiag.showAlertDialog(context, 'Status',
            'Doctor Successfully Added', AdminRoutes.VIEW_DOCTORS);
      } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final serviceField = StreamBuilder<QuerySnapshot>(
      ...
      child: RaisedButton(
          ...
          onPressed: () {
            setState(() {
              ...
              user.access= ACCESS_DOCTOR;
              user.status=STATUS_ACTIVE;
              user.serviceId=workerCategory;
              _addData(
                  user: user,
