        ...
        child: ListView(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.pushNamed(context, AdminRoutes.VIEW_ADMINS);
              },
            ),
            new ListTile(
              leading: Icon(Icons.person),
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.pushNamed(context, AdminRoutes.VIEW_DOCTORS);
              },
            ),
            new ListTile(
              leading: Icon(Icons.person),
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.pushNamed(context,AdminRoutes.VIEW_PATIENTS);
              },
            ),
            ...
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                Navigator.pushNamed(context, AdminRoutes.VIEW_SERVICES);
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, AdminRoutes.VIEW_SCHEDULES);
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context,AdminRoutes.VIEW_EMERGENCIES);
              },
            ),
            new ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, AdminRoutes.VIEW_HEALTH_TIPS);
              },
            ),
            new ListTile(
